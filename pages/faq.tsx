...
function faq(props: faqProps) {
  return (
    <Wrapper maxWidth='80ch'>
      ...
      <FAQ question='Why should I use a licensed driller?'>
        <>
          <p>
            Backyard Bores and Geotech Drilling have several licensed drillers
            and we work to relevant government requirements.
          </p>
          <p>
          ...
          <p>
            Use a licensed driller who has all relevant insurances, why risk it
            to save a couple of hundred dollars?
          </p>
        </>
      </FAQ>
      <FAQ question='Do I need council approval to get a bore?'>
        <p>
      ...
      <FAQ question='How much does it cost? I thought bores were expensive!'>
        <p>
      ...
      <FAQ question='Does backyard bores do divining (dowsing) for water?'>
        <>
          <p>
            No. It doesn't work for us but{' '}
            <StyledLink href='/contact'>contact us</StyledLink> and we can give
            you the numbers of several local diviners. We do have a good
            knowledge of the areas around Mackay that have water and what depth
            a usable bore will be.
          </p>
          <p>
      ...
      <FAQ question='What utilities do I need to search for in preparation for drilling?'>
        <>
          ...
          <p>
            ...
            would be fantastic. Also look for town water, power, storm water,
            down pipes, phone etc.
          </p>
          <p>
          ...
          <p>
            It’s <strong>VERY IMPORTANT</strong> for you to locate these
            services as it is your responsibility as the landowner or their
            authorised representative.{' '}
            <StyledLink href='/contact'>Call us</StyledLink> if you have
            concerns, we can apply for the plans from council for a $58 fee.
          </p>
        </>
      </FAQ>
      <FAQ
        id='drilling-in-my-yard'
        question='Will the drilling rig fit in my yard?'
      >
        <>
          <p>
