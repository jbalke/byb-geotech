    ...
    >
      <PageSection>
        ...
        <p>
          ...
          following 6 things so we can recommend the most suitable pump for your
          needs:
        </p>
        <ol>
          <li>
          ...
          <li>
            When the bore was last equipped with a pump or when the bore was
            last cleaned out?
          </li>
        </ol>
        <p>
          Our pumps are priced as fully installed,{' '}
          <b>no extra hidden charges</b> for foot vales, poly pipe, poly
          fittings, thread tape, glue, taps, hose connectors etc.
        </p>
        <p>
          If you are considering a pump for your <b>new bore</b>, we could bring
          one on drilling day and you can be watering your lawn before we drive
          out the driveway.
        </p>
        <p>
          ...
          page if the bore has not been used in a year or more, or you suspect
